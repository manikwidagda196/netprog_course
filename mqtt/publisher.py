...
try:
    while True: 
        ...
        client.publish('python', 'Nama : I Ketut Manik Widagda')
        client.publish('python/CA171/mqtt', 'netprogCA171 manik')
        client.publish('python/CA171/socket', 'netprogCA171 manik')
        client.publish('python/CA171/email', 'netprogCA171 manik')
